    ...
    >
      ...
      <div className="w-full max-w-3xl bg-white rounded-xl p-0 shadow-lg flex overflow-auto">
          ...
          <div className="w-1/2 bg-gradient-to-r from-slate-900 to-blue-900 text-white p-8 min-h-[400px] flex flex-col">
                <h2 className="text-6xl font-bold mb-20 text-white transition duration-300 hover:text-white hover:drop-shadow-[0_0_10px_rgba(255,255,255,0.7)]">CriptoHub</h2>
                <p className="text-base text-gray-200 leading-relaxed">
                   CriptoHub este locul ideal pentru a învăța, experimenta și înțelege ecosistemul criptomonedelor. 
                </p>
